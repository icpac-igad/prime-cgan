                ...
                >
                    <div className="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
                        ...
                        <p className="text-gray-900 text-left sm:line-height-2 md:line-height-4 text-2xl mt-4">
                            ...
                            Nations World Food Programme (WFP) for the implementation of a pioneering project titled "Strengthening Early Warning Systems for Anticipatory Actions." This initiative, aimed at leveraging machine learning to enhance
                            early warning information systems, marks a collaborative effort involving leading weather and climate research institutions, a university, and a humanitarian organization.
                        </p>
                        <p className="text-gray-900 text-left sm:line-height-2 md:line-height-4 text-2xl mt-4">
